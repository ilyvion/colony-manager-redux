...
#pragma warning restore CS8618
        ...
        private static readonly MethodInfo DrawHeader_MethodInfo
            = AccessTools.Method(typeof(PawnColumnWorker_Label), nameof(DrawHeader));

        private static void DrawHeader(Rect rect, string _, PawnTable table, PawnColumnWorker_Label @this)
        {
        ...
        private static void CustomDoHeader(PawnColumnWorker_Label @this, Rect rect, PawnTable table)
        {
        ...
        {
            CustomDoHeader(this, rect, table);
        }
