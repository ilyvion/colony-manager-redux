...
[HotSwappable]
internal sealed class LegacyPawnKindSettings_Livestock : IExposable
{
...
#pragma warning disable CS8618 // Set by ManagerSettings_Livestock/scribe
    public LegacyPawnKindSettings_Livestock() { }
#pragma warning restore CS8618

    public LegacyPawnKindSettings_Livestock(
        PawnKindDef pawnKindDef,
        LegacyPawnKindSettings_Livestock copyFrom
    )
        : this()
    {
        _def = pawnKindDef;
...
/// Scribe can still deserialize this type (and its nested
/// <see cref="LegacyPawnKindSettings_Livestock"/>) by name out of a save written before default
/// job values moved to <see cref="ManagerDefaultSettings_Livestock"/>, for
/// <see cref="ManagerDefaultSettings_Livestock.MigrateFrom"/> to read from.
/// </summary>
[HotSwappable]
internal sealed class ManagerSettings_Livestock : ManagerSettings
{
    // internal (not private): read by ManagerDefaultSettings_Livestock.MigrateFrom
    internal LegacyPawnKindSettings_Livestock defaults = new();
    internal Dictionary<PawnKindDef, LegacyPawnKindSettings_Livestock> overrides = [];
    ...
    private LegacyPawnKindSettings_Livestock? currentOverrideTab;
                    ...
                    foreach (var pawnKindDef in PawnKindDefs)
                    {
                        ...
                        options.Add(
                            new FloatMenuOption(
                                ...
                                () =>
                                {
                                    LegacyPawnKindSettings_Livestock @override = new(
                                        pawnKindDef,
                                        defaults
                                    )
                                    {
    ...
    public LegacyPawnKindSettings_Livestock GetSettingsFor(PawnKindDef pawnKind) =>
